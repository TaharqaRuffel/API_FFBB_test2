# Generated by Django 3.2 on 2021-07-01 06:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='matches', to='ffbbapi.day')),
                ('gym', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='matches', to='ffbbapi.place')),
                ('home', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='matches_home', to='ffbbapi.team')),
                ('visitor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='matches_visitor', to='ffbbapi.team')),
            ],
        ),
        migrations.AddField(
            model_name='day',
            name='pool',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='days', to='ffbbapi.pool'),
        ),
        migrations.AddField(
            model_name='club',
            name='address',
